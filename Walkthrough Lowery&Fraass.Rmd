...
There are instances (the Danian here, for example) where the additional resolution is useful because of the increased amount of work devoted to understanding the recovery (e.g., Hull and Norris, 2011; Lowery et al., 2018). With a longer record however, the zone scheme is appropriate.
